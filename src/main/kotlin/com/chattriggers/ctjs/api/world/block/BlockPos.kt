...
class BlockPos(x: Int, y: Int, z: Int) : Vec3i(x, y, z), CTWrapper<MCBlockPos> {
    ...
    constructor(source: Entity) : this(source.getBlockPos())
    ...
    @JvmOverloads
    fun offset(facing: BlockFace, n: Int = 1): BlockPos = BlockPos(x + facing.getOffsetX() * n, y + facing.getOffsetY() * n, z + facing.getOffsetZ() * n)
